...
INSERT INTO `users` (`first_name`, `last_name`, `job_title`, `email`, `manager`, `password`, `role`, `created_at`, `created_by`, `fk_department_id`) VALUES ('John', 'McCain', 'Help Desk', 'jm@gmail.com', 'Marta', '123', 'ROLE_USER', CURDATE(), 'AUTOMATIC_FILL', '1');
INSERT INTO `users` (`first_name`, `last_name`, `job_title`, `email`, `manager`, `password`, `role`,`created_at`, `created_by`, `fk_department_id`) VALUES ('Ana', 'Pereira', 'Accountant', 'ap@gmail.com', 'Natacha', '123', 'ROLE_USER', CURDATE(), 'AUTOMATIC_FILL', '2');
INSERT INTO `users` (`first_name`, `last_name`, `job_title`, `email`, `manager`, `password`, `role`,`created_at`, `created_by`, `fk_department_id`) VALUES ('Tao', 'Lee', 'Creative', 'tl@gmail.com', 'Leo', '123', 'ROLE_USER', CURDATE(), 'AUTOMATIC_FILL', '3');
INSERT INTO `users` (`first_name`, `last_name`, `job_title`, `email`, `manager`, `password`, `role`,`created_at`, `created_by`, `fk_department_id`) VALUES ('Lin', 'Khoo', 'Video Editor', 'lk@gmail.com', 'Steve', '123', 'ROLE_USER', CURDATE(), 'AUTOMATIC_FILL', '4');
INSERT INTO `users` (`first_name`, `last_name`, `job_title`, `email`, `manager`, `password`, `role`,`created_at`, `created_by`, `fk_department_id`) VALUES ('Patricia', 'Oneil', 'Social Media Specialist', 'po@gmail.com', 'Toni', '123', 'ROLE_USER', CURDATE(), 'AUTOMATIC_FILL', '5');
